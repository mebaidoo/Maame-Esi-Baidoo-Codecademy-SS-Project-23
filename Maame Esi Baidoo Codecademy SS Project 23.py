...
brooklyn_mean = np.average(brooklyn_one_bed["rent"])
manhattan_mean = np.average(manhattan_one_bed["rent"])
queens_mean = np.average(queens_one_bed["rent"])

# Add median calculations below
brooklyn_median = np.median(brooklyn_one_bed["rent"])
manhattan_median = np.median(manhattan_one_bed["rent"])
queens_median = np.median(queens_one_bed["rent"])

# Add mode calculations below
brooklyn_mode = stats.mode(brooklyn_one_bed["rent"])
manhattan_mode = stats.mode(manhattan_one_bed["rent"])
queens_mode = stats.mode(queens_one_bed["rent"])
